window.addEventListener("load",function(){
    ...
    // Not supported
        ...
        //HTTP Post Request
        var URL = "https://melanomadetection1-prediction.cognitiveservices.azure.com/customvision/v3.0/Prediction/af94bb94-91da-45fd-b114-040b2cac9c88/classify/iterations/melanomaDetection/image";
        var xhr = new XMLHttpRequest();
        
        xhr.open('POST', URL, true);
        xhr.setRequestHeader('Prediction-Key','edac2b4b742942c3aa3f436178fa9655');
